...
// OpenAIGenerator 实现基于OpenAI的生成器
...
func NewArkGenerator(baseURL, apiKey, modelName string) *OpenAIGenerator {
...
// Generate 生成回答
func (g *OpenAIGenerator) Generate(ctx context.Context, query string, documents []*schema.Document) (string, error) {
	// 组合上下文信息
	context := ""
	if len(documents) > 0 {
